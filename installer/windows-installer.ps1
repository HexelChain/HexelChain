...
Write-Host "You need to then customize your hexel_config.json to set up configurations. After that, you can run launch.py to start your AIOS web UI locally."
