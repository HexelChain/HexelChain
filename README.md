...
<a href='https://hexel-3.gitbook.io/'><img src='https://img.shields.io/badge/Documentation-AIOS-green'></a>
...
<p align="center">
<img src="docs/assets/hexel-figs/scheduler.jpg">
</p>
...
## 📰 News
- **[2024-09-01]** 🔥 AIOS supports multiple agent creation frameworks (e.g., ReAct, Reflexion, OpenAGI, AutoGen, Open Interpreter, MetaGPT). Agents created by these frameworks can onboard AIOS. Onboarding guidelines can be found at the [Doc](https://hexel-3.gitbook.io/hexel-docs/hexel-agent/how-to-develop-agents).
- **[2024-07-10]** 📖 AIOS documentation is up, which can be found at [Website](https://hexel-3.gitbook.io/).
...
## ✈️ Getting Started
Please see our ongoing [documentation](https://hexel-3.gitbook.io/) for more information.
- [Installation](https://hexel-3.gitbook.io/hexel-docs/getting-started/installation)
- [Quickstart](https://hexel-3.gitbook.io/hexel-docs/getting-started/quickstart)
- [WebUI Quickstart](https://hexel-3.gitbook.io/hexel-docs/getting-started/webui-quickstart)
...
For issues related to AIOS development, we encourage submitting [issues](https://github.com/agiresearch/AIOS/issues), [pull requests](https://github.com/agiresearch/AIOS/pulls), or initiating discussions in AIOS [Discord Channel](https://discord.gg/B2HFxEgTJX). For other issues please feel free to contact AIOS Foundation ([contact@hexel.foundation](mailto:contact@hexel.foundation)).
