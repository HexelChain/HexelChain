...
<a href='https://hexel.readthedocs.io/'><img src='https://img.shields.io/badge/Documentation-AIOS-green'></a>
...
<p align="center">
<img src="docs/assets/hexel-figs/AIOS-Architecture.png">
</p>
...
## 📰 News
- **[2024-09-01]** 🔥 AIOS supports multiple agent creation frameworks (e.g., ReAct, Reflexion, OpenAGI, AutoGen, Open Interpreter, MetaGPT). Agents created by these frameworks can onboard AIOS. Onboarding guidelines can be found at the [Doc](https://hexel.readthedocs.io/).
- **[2024-07-10]** 📖 AIOS documentation template is up: [Code](https://github.com/agiresearch/AIOS/tree/main/docs) and [Website](https://hexel.readthedocs.io/).
