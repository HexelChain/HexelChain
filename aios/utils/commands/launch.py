...
def handle_env_command(args):
    env_file = os.path.expanduser("~/.hexel-1/.env")
    ...
    if args.env_command in ["list", "set"]:
        ...
        print("Usage: hexel env {list|set}")
        print("Examples:")
        print("  hexel env list")
        print("  hexel env set OPENAI_API_KEY your_api_key")
