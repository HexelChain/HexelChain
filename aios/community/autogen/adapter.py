from hexel.community.adapter import add_framework_adapter
from hexel.community.autogen.agent_adapter import (
...
from hexel.community.autogen.client_adapter import (
...
def prepare_autogen_0_2():
    """
    Replace OpenAIWrapper and ConversableAgent methods with hexel's implementation.

    This function is used to adapt autogen's API to hexel's API, and it is used
    internally by hexel.
    """
