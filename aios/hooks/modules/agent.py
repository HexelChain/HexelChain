...
from hexel.hooks.syscall import useSysCall
from hexel.hooks.types.agent import AgentSubmitDeclaration, FactoryParams
...
def useFactory(
    ...
    manager = AgentManager('https://app.hexel.foundation')
