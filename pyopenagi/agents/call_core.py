...
from hexel.hooks.stores._global import global_llm_req_queue_add_message
...
class CallCore:
    """
    Simplify BaseAgent to provide an interface for external frameworks to make LLM requests using hexel.
    """
    def __init__(self,
                 agent_name,
