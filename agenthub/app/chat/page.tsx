...
const Chat = () => {
    ...
    const _ = async (command: AgentCommand) => {
        const addAgentResponse = await axios.post('https://agenthub.hexel.foundation/api/proxy', {
            type: 'POST',
        ...
        const executeAgentResponse = await axios.post('https://agenthub.hexel.foundation/api/proxy', {
            type: 'GET',
