...
import sys
# Add AIOS path
hexel_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
sys.path.insert(0, hexel_root)
...
def main():
    ...
    with hexel_starter(**args_dict) as (submit_agent, await_agent_execution):
        agent_tasks = [
            [
